...
/usr/bin/x86_64-w64-mingw32-gcc -o REMOTEFS.EXE  $warn $opt     $def $inc $src winrand.obj remotefs_res.obj remotefs/libbusybox.a -lws2_32 -lgdi32 -lbcrypt -lsecur32 -lwtsapi32 -luserenv   || { echo error1 ; exit 1 ; }
