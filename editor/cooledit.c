...
/* The following are hints that go on the title bar: eg "Cooledit - Hint: Undo key-for-key with Ctrl-Backspace" */
	...
	gettext_noop("Highlight and drag function prototypes and other info from the man page browser"),
	...
	gettext_noop("Compose international characters with Alt-\\ and watch the status bar"),
	gettext_noop("Insert decimal literal character code-points with Control-q and 3 decimal digits"),
	gettext_noop("Insert hexadecimal code-points like Control-q F F"),
	gettext_noop("Insert Unicode code-points with Ctrl-q u then six hexadecimal digits"),
	gettext_noop("Try Ctrl-q u 0 1 f 6 0 0"),
	...
	gettext_noop("Open a file by dragging its name from the 'File browser' onto the igloo"),
	...
	gettext_noop("Use Ctrl-Tab to complete the start of string or token"),
	...
	gettext_noop("Add a debugger variable display with 'Display variable...' in the Debug menu"),
