...
typedef struct s_xlat K_XLAT;
struct s_xlat {
    u_int           first, last;
    u_int          *pval;	/* array of translated values */
};

typedef struct s_switch K_SWITCH;
struct s_switch {
...
typedef struct s_state K_STATE;
struct s_state {
...
typedef struct s_xlat_type XLAT_TYPE;
struct s_xlat_type {
    char           *plain;
    char           *accent;
    char           *accent_xtra;
...
static char     elot_xlat_acc[] = "65-122:182,194,216,196,184,214,195,185,186,206,202,203,204,205,188,208,81,209,211,212,200,191,87,215,190,198,91,92,93,94,95,96,220,226,"	/*248 */
    "169,228,221,246,227,222,223,238,234,235,236,237,252,240,113,241,"
    /*243 */ "167,244,232,254,242,247,253,230";
...
static XLAT_TYPE xlat_type[] = {
    ...
    {elot_xlat_plain, elot_xlat_acc, elot_xlat_acc_xtra, elot_xlat_uml,
     elot_xlat_umacc},
    {i437_xlat_plain, i437_xlat_acc, i437_xlat_acc_xtra, i437_xlat_uml,
     i437_xlat_umacc},
};
...
/* add a new xlat table in state */
	...
	pStateNow->xlat =
	    realloc (pStateNow->xlat,
		     (pStateNow->num_xlat + 1) * sizeof (K_XLAT));
