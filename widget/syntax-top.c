...
"include sh.syntax",
"",
"file ..\\*\\\\.(ini|desktop|busname|(auto)?mount|net(dev|work)|link|path|service|slice|socket|swap|target|timer)$ INI-based\\sFile",
"include ini.syntax",
"",
"file ..\\*\\\\.((pl|pm|psgi)|t)$ Perl\\sProgram ^#!.\\*([\\s/]perl|perl)",
"include perl.syntax",
"",
"file ..\\*\\\\.py$ Python\\sProgram ^#!.\\*([\\s/]python|python)",
...
"",
"file ..\\*\\\\.html?$ HTML\\sFile DOCTYPE\\s(HTML|html)",
"include html.syntax",
"",
"file ..\\*\\\\.((xml|xsd|xslt?|dtd)|qpg|qpg\\\\.in)$ XML\\sdocument (\\\\?xml\\sversion|!DOCTYPE\\s)",
"include xml.syntax",
"",
"file ..\\*\\\\.cir$ Spice\\scircuit",
"include spice.syntax",
"",
"file ..\\*\\\\.tt$ Template::Toolkit\\sFile",
"include tt.syntax",
"",
...
"",
"file ..\\*\\\\.(pas|dpr|inc)$ Pascal\\sProgram",
"include pascal.syntax",
"",
"file ..\\*\\\\.ad[abs]$ Ada\\sProgram",
"include ada95.syntax",
"",
"file ..\\*\\\\.i?tcl$ Tcl\\sProgram ^#!.\\*([\\s/]tclsh|[\\s/]wish|/usr/bin/tclsh|/usr/bin/wish)",
"include tcl.syntax",
"",
"file ..\\*\\\\.sl$ S-Lang\\sProgram",
"include slang.syntax",
"",
"file ..\\*\\\\.tex$ LaTeX\\s2.09\\sDocument",
"include latex.syntax",
"",
"file ..\\*\\\\.(texi|texinfo)$ Texinfo\\sDocument",
...
"include c.syntax",
"",
"file ..\\*\\\\.([hC]|(cxx|cc|cpp|c\\\\\\+\\\\\\+|hxx|hh|hpp|h\\\\\\+\\\\\\+|ino)|[Hh]\\\\.in)$ C/C\\+\\+\\sProgram",
"include cxx.syntax",
"",
"file ..\\*\\\\.d$ D\\sProgram",
"include d.syntax",
"",
"file ..\\*\\\\.f$ Fortran\\sProgram",
...
"include rust.syntax",
"",
"file ..\\*\\\\.f9[05]$ Freeform\\sFortran\\sProgram",
"include f90.syntax",
"",
"file ..\\*\\\\.i$ SWIG\\sSource",
"include swig.syntax",
...
"include j.syntax",
"",
"file ..\\*\\\\.(java?|groovy)$ Java\\sProgram",
"include java.syntax",
"",
...
"include cs.syntax",
"",
"file ..\\*\\\\.m?js$ JavaScript\\sProgram ^#!.\\*[\\s/](node|nodejs)\\\\b",
"include js.syntax",
"",
"file ..\\*\\\\.json$ JSON\\sFile",
"include json.syntax",
"",
"file ..\\*\\\\.ts$ TypeScript\\sProgram",
"include ts.syntax",
"",
"file ..\\*\\\\.as$ ActionScript\\sProgram",
"include as.syntax",
"",
...
"",
"file ..\\*\\\\.sql$ SQL\\sProgram",
"include sql.syntax",
"",
"file ..\\*\\\\.hql$ HiveQL\\sProgram",
"include hive.syntax",
"",
...
"",
"file ..\\*\\\\.hsc?$ Haskell\\sprogram",
"include haskell.syntax",
"",
"file ..\\*\\\\.cabal$ Cabal\\sconfig\\sfile",
"include cabal.syntax",
"",
"file ..\\*\\\\.n$ Nemerle\\sProgram",
"include nemerle.syntax",
"",
"file ..\\*\\\\.(v|sv|vh|svh)$ Verilog/SystemVerilog\\sDevice\\sDescription",
"include verilog.syntax",
"",
"file ..\\*\\\\.(hdl|vhdl?)$ VHDL\\sDevice\\sDescription",
"include vhdl.syntax",
"",
...
"",
"file ..\\*\\\\.jalt?$ Jal\\ssource",
"include jal.syntax",
"",
"file ..\\*\\\\.lkr$ PIC\\slinker\\sscript\\sfile",
"include lkr.syntax",
"",
...
"",
"file ..\\*\\\\.yab$ Yabasic\\s(Yet\\sAnother\\sBASIC)",
"include yabasic.syntax",
"",
"file ..\\*\\\\.(cbl|cob)$ Cobol\\sProgram",
